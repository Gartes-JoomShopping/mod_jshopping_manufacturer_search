...
manufacturerSearch.getSelectInputHtml = function(elem) {
	return '<li class="search-choice"><span>' + manufacturerSearch.$(elem).next('label').text() + '</span><a href="javascript:void(0)" class="search-choice-close" onclick="manufacturerSearch.removeSelectInput(\''+elem.id+'\', this)"></a></li>';
}
